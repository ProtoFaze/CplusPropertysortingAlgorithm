...
// of size atmost RUN 
void insertionSort(Vlist<Property>& arr, int left, int right, int type) 
{ 
...
void merge(Vlist<Property>& arr, int l, int m, int r, int type) 
{
...
void timSort(Vlist<Property>& arr, int n, int type) 
{ 
