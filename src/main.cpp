...
int cleanData() {
    ...
    container.importRaw(".././dataset/mudah-apartment-kl-selangor.csv");
...
int main(){
    ...
    // for (int i; i<10; i++){
        ...
        auto stop = high_resolution_clock::now();
        auto duration = duration_cast<milliseconds>(stop - start);
        // cout << "Time taken by tim to sort name: "<< i << " " << duration.count() << "ms" << endl;
        printTim(prop, size);
    // }
    // for (int i; i<10; i++){
    //     int size = prop.getSize();
    ...
    //     auto stop = high_resolution_clock::now();
    //     // auto duration = duration_cast<milliseconds>(stop - start);
    //     // cout << "Time taken by tim to sort monthly rent: "<< i << " " << duration.count() << "ms" << endl;
    //     printTim(prop, size);
    // }
    // for (int i; i<10; i++){
    //     int size = prop.getSize();
